<%@ page title="" language="C#" masterpagefile="~/MasterPage/User.master" autoeventwireup="true" inherits="Company_Tenders, App_Web_r3obomnm" %>
...
<div style="width: 520px; background-color: #FFFFD9;height:900px;">
  ...
  <br />
         ...
         <br />
         <br />
          <asp:DataList ID="TenderDetails" runat="server" RepeatColumns="1" DataKeyField="TenderId">
