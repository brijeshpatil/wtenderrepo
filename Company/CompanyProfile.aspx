<%@ page title="" language="C#" masterpagefile="~/MasterPage/User.master" autoeventwireup="true" inherits="Company_CompanyProfile, App_Web_r3obomnm" %>
...
<div>
    <asp:FormView ID="frmCompanyProfile" runat="server" 
        onitemupdating="frmCompanyProfile_ItemUpdating" DataKeyNames="ProfileId" 
        onitemcommand="frmCompanyProfile_ItemCommand" 
        onpageindexchanging="frmCompanyProfile_PageIndexChanging" 
        onmodechanging="frmCompanyProfile_ModeChanging"  ForeColor="Black" BorderColor="#CC9966" 
