<%@ page title="" language="C#" masterpagefile="~/MasterPage/Admin.master" autoeventwireup="true" inherits="Admin_ManageBuyer, App_Web_qxecay11" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="Server">
    <center>
        <div style="background-color: #FFFFD9; height: 900px; width: 500px;">
            ...
            <center>
                <h3>
                    <font size="5px" style="background-color: #FFFFCC; font-size: x-large; font-weight: bolder;
                        ...
                        font-family: 'Times New Roman', Times, serif;">Manage Buyer</font></h3>
            </center>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:DetailsView ID="BuyerDetail" runat="server" Height="600px" Width="400px" OnItemDeleting="BuyerDetail_ItemDeleting"
                OnItemUpdating="BuyerDetail_ItemUpdating" OnModeChanging="BuyerDetail_ModeChanging"
                OnPageIndexChanging="BuyerDetail_PageIndexChanging" AllowPaging="True" AutoGenerateRows="False"
                BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px"
                CellPadding="4" DataKeyNames="ProfileId">
                ...
                <Fields>
                    ...
                    <asp:TemplateField HeaderText="Image">
                        ...
                        <ItemTemplate>
                            <asp:Image ID="Image1" runat="server" Height="100px" ImageUrl='<%# bind("Image") %>'
                                Width="100px" />
                        </ItemTemplate>
                    </asp:TemplateField>
                  ...
                  <%--  <asp:TemplateField HeaderText="HintQuestion">
                    ...
                    <asp:TemplateField HeaderText="IsBlock">
                        <EditItemTemplate>
                            <asp:CheckBox ID="chkIsBlock" runat="server" Text="IsBlock" Checked='<%# bind("IsBlock") %>' />
                        </EditItemTemplate>
                        <ItemTemplate>
