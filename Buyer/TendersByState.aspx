<%@ page title="" language="C#" masterpagefile="~/MasterPage/Buyer.master" autoeventwireup="true" inherits="Buyer_TendersByState, App_Web_j2telni5" %>
...
<br />
    ...
    <asp:GridView ID="grvState" runat="server" AutoGenerateColumns="False" 
        ...
        CellPadding="4" AllowPaging="True" 
            ...
            DataKeyNames="TenderId" onrowcommand="grvState_RowCommand" 
            ondatabound="grvState_DataBound">
        <Columns>
