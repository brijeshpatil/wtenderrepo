<%@ page title="" language="C#" masterpagefile="~/MasterPage/Buyer.master" autoeventwireup="true" inherits="Buyer_TendersByCompany, App_Web_j2telni5" %>
...
<br />
    ...
    <asp:GridView ID="grvCompany" runat="server" AllowPaging="True" 
        ...
        DataKeyNames="TenderId" onrowcommand="grvCompany_RowCommand" 
        ondatabound="grvCompany_DataBound">
        <Columns>
